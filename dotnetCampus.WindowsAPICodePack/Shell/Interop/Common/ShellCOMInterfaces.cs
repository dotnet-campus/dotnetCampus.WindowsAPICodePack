...
using System.Text;
using dotnetCampus.WindowsAPICodePack.Shell.PropertySystem;
using dotnetCampus.WindowsAPICodePack.Taskbar;
...
#pragma warning disable 108
    ...
    interface IThumbnailCache
    {
        ...
        [In] dotnetCampus.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailOptions flags,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out dotnetCampus.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags,
        [Out] dotnetCampus.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailId pThumbnailID);

        void GetThumbnailByID([In] dotnetCampus.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailId thumbnailID,
        [In] uint cxyRequestedThumbSize,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out dotnetCampus.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags);
    }
