...
namespace dotnetCampus.WindowsAPICodePack.Taskbar
{
    /// <summary>
    ...
    public class ThumbnailToolBarManager
    {
        ...
        /// properties on the <see cref="T:dotnetCampus.WindowsAPICodePack.Taskbar.ThumbnailToolBarButton"/>. While individual buttons cannot be added or removed, 
        /// they can be shown and hidden through <see cref="P:dotnetCampus.WindowsAPICodePack.Taskbar.ThumbnailToolBarButton.Visible"/> as needed. 
