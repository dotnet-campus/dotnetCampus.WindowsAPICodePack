...
namespace dotnetCampus.WindowsAPICodePack.Taskbar
{
    ...
    public class TaskbarManager
    {
        ...
        /// top-level window whose taskbar button will hold the custom JumpList built through the methods <see cref="dotnetCampus.WindowsAPICodePack.Taskbar.JumpList"/> class.
