...
using System.Text;
using System.Linq;
using dotnetCampus.WindowsAPICodePack.Shell.Interop;

namespace dotnetCampus.WindowsAPICodePack.Controls.WindowsForms
{
    /// <summary>
    ...
    public sealed class ExplorerBrowser :
        ...
        dotnetCampus.WindowsAPICodePack.Controls.IServiceProvider,
        ...
        IMessageFilter
    {
        ...
        /// <returns></returns>
        HResult dotnetCampus.WindowsAPICodePack.Controls.IServiceProvider.QueryService(
