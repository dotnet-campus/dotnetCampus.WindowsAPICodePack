...
namespace dotnetCampus.WindowsAPICodePack.Controls.WindowsPresentationFoundation
{
    /// <summary>
    ...
    public partial class ExplorerBrowser : UserControl, IDisposable
    {
        ...
        /// </summary>
        public dotnetCampus.WindowsAPICodePack.Controls.WindowsForms.ExplorerBrowser ExplorerBrowserControl
        {
            get;
            set;
        }
        ...
        public ExplorerBrowser()
        {
            ...
            ExplorerBrowserControl = new dotnetCampus.WindowsAPICodePack.Controls.WindowsForms.ExplorerBrowser();
