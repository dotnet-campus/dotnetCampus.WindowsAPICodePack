...
using dotnetCampus.WindowsAPICodePack.Controls;
using dotnetCampus.WindowsAPICodePack.Dialogs.Controls;
using dotnetCampus.WindowsAPICodePack.Shell;
using MS.WindowsAPICodePack.Internal;
using System.Collections.Generic;
using dotnetCampus.WindowsAPICodePack.Resources;

namespace dotnetCampus.WindowsAPICodePack.Dialogs
{
    /// <summary>
    ...
    public abstract class CommonFileDialog : IDialogControlHost, IDisposable
    {
        ...
        /// </summary>
        /// <value>A <see cref="dotnetCampus.WindowsAPICodePack.Shell.ShellObject"></see> object.</value>
        ...
        /// <summary>
        /// Sets the location (<see cref="dotnetCampus.WindowsAPICodePack.Shell.ShellContainer">ShellContainer</see> 
